...
class RadioDAO: NSObject {
    ...
    func returnAllRadios() -> Array<Radio> {
        ...
        let song2 = Radio(url: "Song1", format: "mp3", jacket: UIImage(named: "Radio2"), artistImage: UIImage(named: "artist2_sqrt"), bio: "", caption: "caption 1", username: "@username 1", audioTrackName: "audio 1", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370")
        let song3 = Radio(url: "Song1", format: "mp3", jacket: UIImage(named: "Radio3"), artistImage: UIImage(named: "artist3_sqrt"), bio: "", caption: "caption 1", username: "@username 1", audioTrackName: "audio 1", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370")
        let song4 = Radio(url: "Song1", format: "mp3", jacket: UIImage(named: "Radio4"), artistImage: UIImage(named: "artist4_sqrt"), bio: "", caption: "caption 1", username: "@username 1", audioTrackName: "audio 1", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370")
        let song5 = Radio(url: "Song1", format: "mp3", jacket: UIImage(named: "Radio5"), artistImage: UIImage(named: "artist5_sqrt"), bio: "", caption: "caption 1", username: "@username 1", audioTrackName: "audio 1", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370")
