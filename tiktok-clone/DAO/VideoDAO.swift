...
class VideoDAO: NSObject {
    ...
    func returnAllVideos() -> Array<Video> {
        ...
        let video1 = Video(url: "IMG_2944", format: "MOV", caption: "caption 1", username: "@username 1", audioTrackName: "audio 1", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370")
        let video2 = Video(url: "IMG_3117", format: "MOV", caption: "caption 2", username: "@username 2", audioTrackName: "audio 2", likesNumber: "260k", commentsNumber: "1.4k", shareNumber: "370")
        let video3 = Video(url: "IMG_3118", format: "MOV", caption: "caption 3", username: "@username 3", audioTrackName: "audio 3", likesNumber: "1.1M", commentsNumber: "56k", shareNumber: "5k")
        let video4 = Video(url: "IMG_3119", format: "MOV", caption: "caption 4", username: "@username 4", audioTrackName: "audio 4", likesNumber: "16.4k", commentsNumber: "200", shareNumber: "42")
        let video5 = Video(url: "IMG_3120", format: "MOV", caption: "caption 5", username: "@username 5", audioTrackName: "audio 5", likesNumber: "260k", commentsNumber: "10.6k", shareNumber: "900")
