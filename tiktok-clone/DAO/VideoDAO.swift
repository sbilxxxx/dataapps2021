...
class VideoDAO: NSObject {
    ...
    func returnAllVideos() -> Array<Video> {
        ...
        let video1 = Video(url: "Reel1", format: "mp4", caption: "caption 1", username: "ジョン", audioTrackName: "2021/9/2 結成2周年ライブ@ライブハウスgangan", artistImage: UIImage(named: "Sq1"), bio: "皆さんこんにちは!\n東京を中心に路上ミュージシャンをしているジョンです!!\n自分の歌で1人でも多くの人が幸せになってくれるよう一生懸命歌います!\nフォロー・応援よろしくお願いします!!", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370", ArtistRep: "大阪", FollowedNumber: "136フォロワー", ArtistView: UIImage(named:"Main1"), comment_1: "この歌声は奇跡！Newdioから紅白、来るのでは？！", comment_2: "ギターの技術が高い、普通にヤバイ", pro_1: UIImage(named: "pro1"), pro_2: UIImage(named:  "pro2"))
        let video2 = Video(url: "Reel2", format: "mp4", caption: "caption 1", username: "ポール", audioTrackName: "Take me home (official MV)", artistImage: UIImage(named: "Sq2"), bio: "仙台市を中心に活動しているポールです!\n現在はsakana大学に在学中で卒業後はプロのミュージシャンになることを目指しています!\n好きなジャンルはフォークソングです!\n自分で曲も書いたりしているので、ぜひチェックしてみてください!\nフォロー・応援よろしくお願いします!!", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370", ArtistRep: "奈良", FollowedNumber: "136フォロワー", ArtistView: UIImage(named:"Main2"), comment_1: "初見でマジ驚いた、全員聴くべし", comment_2: "ゴリゴリにうまい！！！", pro_1: UIImage(named: "pro3"), pro_2: UIImage(named:  "pro4"))
        let video3 = Video(url: "Reel3", format: "mp4", caption: "caption 1", username: "ハリスン", audioTrackName: "Novel View (ハリスン) @新宿駅路上ライブ", artistImage: UIImage(named: "Sq3"), bio: "Newdio 始めました!\n僕が作った曲で世界をLove&Peaceにしていきます!\n1日1投稿目指して頑張りたいと思います!!\nフォロー・応援よろしく意願いします!", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370", ArtistRep: "岩手", FollowedNumber: "136フォロワー", ArtistView: UIImage(named:"Main3"), comment_1: "この子は必ず来る！みんな聞こう", comment_2: "しみる歌声、最高です！", pro_1: UIImage(named: "pro5"), pro_2: UIImage(named:  "pro6"))
        let video4 = Video(url: "Reel4", format: "mp4", caption: "caption 1", username: "リンゴ", audioTrackName: "GORINGO (リンゴ) @仙台駅路上ライブ", artistImage: UIImage(named: "Sq4"), bio: "現役大学生バンド「リンゴ」です!\n主に路上ライブを仙台駅前でやってます!!\n好きなジャンルは邦ロック!\n「Sakane Wimps」のカバーをよくしたりしなかったりします!\nFollowよろしくお願いします!!!", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370", ArtistRep: "東京", FollowedNumber: "136フォロワー", ArtistView: UIImage(named:"Main4"), comment_1: "路上でこのレベルは初めて、コラボしたいす", comment_2: "初めてこんな歌声聞いたーー、素晴らしい", pro_1: UIImage(named: "pro7"), pro_2: UIImage(named:  "pro8"))
        let video5 = Video(url: "Reel5", format: "mp4", caption: "caption 1", username: "ヨーコ", audioTrackName: "Let it fire 弾いてみた (ヨーコ)", artistImage: UIImage(named: "Sq5"), bio: "主に弾き語りなんかをしてます、ヨーコです\nギターも弾くけど、何でも弾きます\nピアノとか、ドラムとか\nフォローしてくれると嬉しいなーーー", likesNumber: "26.4k", commentsNumber: "1.4k", shareNumber: "370", ArtistRep: "サンフランシスコ", FollowedNumber: "136フォロワー", ArtistView: UIImage(named:"Main5"), comment_1: "なんだこれは...ヤバい", comment_2: "この声は半端ないね", pro_1: UIImage(named: "pro9"), pro_2: UIImage(named:  "pro10"))
